                ...
                <?php endif ?>
                    <form action="" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="hubungan_dengan_penanggung_jawab" name="hubungan_dengan_penanggung_jawab">
                        </div>
                        <div class="form-group">
                            <label for="alamat_penanggung_jawab">Alamat Penanggung Jawab</label>
                            <input type="text" class="form-control" id="alamat_penanggung_jawab" name="alamat_penanggung_jawab">
                        </div>
                        <div class="form-group">
